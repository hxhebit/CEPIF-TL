...
def get_parser():
    ...
    parser.add_argument('--method', type=str, default='CEPIF-TL')
    ...
    parser.add_argument('--log_dir', type=str, default="./log/CEPIF-TL_{}".format(str(time.time())))
...
def main():
    ...
    if args.local_rank == 0:
        ...
        # results
        result_dir = os.path.join('results', args.method, args.save_folder, args.log_dir[6:]+'_'+args.src_domain + args.tgt_domain + args.tgt_domain_test) # results/TIFS/DSAN_XXX_ABB
        ...
        sys.stdout = Logger(os.path.join(result_dir,args.src_domain + args.tgt_domain + args.tgt_domain_test + '.txt'), sys.stdout) # results/TIFS/DSAN_XXX_ABB_test/ABB_test.txt
